...
::: {.column width="50%"}
<br><br><br> *Missing data can occur anywhere in the box!*

* Constructs are often measured by groups of variables (items). Some or all 
  items for a construct may be missing. 
* Missingness often increases over time in longitudinal studies due to 
  intermittent participation and/or dropout. 
