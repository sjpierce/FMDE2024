...
::: {.notes}
Need to add example of missing data pattern analysis and interpretation. 
:::
...
catgegories, each referring to the probability of missing values given 
information about the variables with missing data, other covariates, and a 
hypothetical mechanism that causes the missing data.
:::


## MCAR
MCAR is when neither observed nor unobserved variables predict which values are 
missing. 
